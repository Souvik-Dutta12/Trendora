...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-5 font-medium'>
      <img className="w-36 invert-[55%]" src={assets.logo} alt="logo" />
      ...
      <div className='flex items-center gap-6 invert'>
        <img src={assets.search_icon} className='cursor-pointer w-5' alt="search" />
        ...
        <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center rounded-full leading-4 bg-black text-white aspect-square text-[8px]'>10</p>
        </Link>

...
const Searchbar = () => {
  ...
  return showSearch && visible ? (
    <div className='border-t border-b bg-zinc-950 text-center'>
        <div className='inline-flex items-center justify-center border border-white px-5 py-2 my-5 mx-3 rounded-full w-3/4 sm:w-1/2'>
            ...
            <img className='w-4 invert cursor-pointer' src={assets.search_icon} alt="search" />
        </div>
      <img onClick={()=>setShowSearch(false)} className='invert inline w-3 cursor-pointer' src={assets.cross_icon} alt="cross" />
    </div>
  ) : null
}
